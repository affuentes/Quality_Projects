...
type
  TDM_QualityProjectsCdsFrm = class(TDataModule)
    ...
    procedure CDS_ManRiesgosNewRecord(DataSet: TDataSet);
...
//EVENTO OnNewRecord DEL CDS_ManRiesgos
procedure TDM_QualityProjectsCdsFrm.CDS_ManRiesgosNewRecord(DataSet: TDataSet);
begin
  CDS_ManRiesgosID_PROYECTO.AsInteger:=V_ID_PROYECTO;
end;
